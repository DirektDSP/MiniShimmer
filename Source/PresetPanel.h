...
namespace Gui
{
	...
	public:
		...
		void resized() override
		{
			...
			previousPresetButton.setBounds(bounds.removeFromLeft(container.proportionOfWidth(0.05f)));
			nextPresetButton.setBounds(bounds.removeFromLeft(container.proportionOfWidth(0.05f)));
